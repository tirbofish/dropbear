...
fn map_material(
    ...
    NMaterial {
        ...
        tint: NVector4::from(material.base_colour),
        ...
        metallic_roughness_texture: material.metallic_roughness_texture.and_then(|v| Some(v.id)),
        occlusion_texture: material.occlusion_texture.and_then(|v| Some(v.id)),
    }
}
